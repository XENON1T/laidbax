...
All of the hard work is done by `blipflip <https://github.com/JelleAalbers/blipflip`; this only contains the code necessary to make blipflip work with a simple Monte Carlo of the XENON1T experiment. Much of this is derived or shamelessly "borrowed" from other sources: 
...
Installation
============
First install the major dependencies: `blipflip` and `pax`. We need pax for the common unit system and XENON1T.ini.
